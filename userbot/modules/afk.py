...
# ========================= CONSTANTS ============================
AFKSTR = [
    "Cipuyy Sedang Offline Yang Berarti Antara : Tidur , Push Rank , Makan 

Jika Ingin Order Key Atau Perpanjang Key Langsung Transfer Ke 

💰 Dana : 087888402005 ( Hadian Firdaus ) 
💰 BCA : 6330784430 ( Yasita Wirdaningrum ) 

Sertakan Bukti Screenshoot Jika Sudah Transfer , Jika Cipuyy Sudah Aktif Akan Langsung Di Proses 👍🏻
